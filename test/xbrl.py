            ...
            for i in task_pbar:
                ...
                if "extract" in data_name:
                    if "tags" in data_name:
                        tmp_context = [f"Extract all XBRL tags from the following financial document:\n\n{x}\n\nExtracted XBRL tags:" for x in tmp_context]
                    elif "value" in data_name:
                        tmp_context = [f"Extract all XBRL values from the following financial document:\n\n{x}\n\nExtracted XBRL values:" for x in tmp_context]
                    elif "formula" in data_name:
                        tmp_context = [f"Extract the formula from the following financial document:\n\n{x}\n\nExtracted formula:" for x in tmp_context]
                else:
                    if data_name == "xbrl_finer":
                        tmp_context = [f"Tag the following financial document with appropriate XBRL tags (FiNER task):\n\n{x}\n\nTags:" for x in tmp_context]
                    elif data_name == "xbrl_fnxl":
                        tmp_context = [f"Tag the following financial document with appropriate FNXL tags:\n\n{x}\n\nTags:" for x in tmp_context]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", default="all", type=str, help="XBRL tasks to test, comma-separated. Use 'all' for all tasks.")
